...
Wiesz, jak działa „tylko na chwilę” – algorytmy już zacierają ręce, a Ty czujesz ukłucie wyrzutów sumienia na samą myśl o kolejnej godzinie przed ekranem. Co robisz?`,
    choices: [
      {
        ...
        consequence: 'Ulegasz dla świętego spokoju',
      ...
      },
      {
        ...
        consequence: 'Szybki zryw – wyjście na dwór',
      ...
      },
      {
        ...
        consequence: 'Złoty środek – analogowa alternatywa',
  ...
  p1_tablet_skrot: {
    id: 'p1_tablet_skrot',
    type: 'story',
    actTitle: 'Warstwa Tabletu',
    timeLabel: '15:50',
    progressPercent: 25,
    image: '/images/tablet_screen.jpg',
...
Algorytmy zrobiły swoje. Co robisz?`,
    choices: [
      ...
      },
      {
        ...
        consequence: 'Sprytne przekierowanie uwagi',
    ...
    choices: [
      {
        ...
        consequence: 'Metoda "klin klinem" – telewizor',
      ...
      },
      {
        ...
        consequence: 'Twardy reset – przymusowe sprzątanie',
      ...
      },
      {
        ...
        consequence: 'Ostatnia deska ratunku – wyciszenie z historią',
        effect: { parentEnergy: -15, childFocus: 25, familyBond: 25, creativityMovement: 5 },
    ...
    choices: [
      {
        ...
        consequence: 'Przekupstwo słodyczami',
      ...
      },
      {
        ...
        consequence: 'Przeczekanie – ciche dni',
      ...
      },
      {
        ...
        consequence: 'Mądry rozejm ze sprytną intrygą',
    ...
    choices: [
      {
        ...
        consequence: 'Kapitulacja na powrocie',
      ...
      },
      {
        ...
        consequence: 'Przetrzymanie i twardy powrót',
      ...
      },
      {
        ...
        consequence: 'Zachęta na spokojny odpoczynek',
  ...
  p3_dwor_kapitulacja: {
    ...
    type: 'story',
    actTitle: 'Odnoga Kapitulacji (Outdoor)',
    timeLabel: '17:00',
    progressPercent: 50,
    ...
    choices: [
      ...
      },
      {
        ...
        consequence: 'Zmiana umowy na audio',
      ...
      },
      {
        ...
        consequence: 'Szachowy podstęp z książki',
  ...
  p4_audio_klocki: {
    id: 'p4_audio_klocki',
    type: 'story',
    actTitle: 'Próba Wyciszenia Audio',
    timeLabel: '17:15',
    progressPercent: 60,
    ...
    choices: [
      {
        ...
        consequence: 'Przełączenie na angażującą opowieść',
      ...
      },
      {
        ...
        consequence: 'Uległość pod wpływem zniecierpliwienia',
    ...
    choices: [
      {
        ...
        consequence: 'Biała flaga dla świętego spokoju',
      ...
      },
      {
        ...
        consequence: 'Mądry rozejm z historią o emocjach',
  ...
  p4_ksiazka_start: {
    id: 'p4_ksiazka_start',
    type: 'story',
    actTitle: 'Warstwa Książki',
    timeLabel: '17:30',
    progressPercent: 70,
    image: '/images/sofa_cozy.jpg',
    ...
    choices: [
      {
        ...
        consequence: 'Klasyka – bajka znana od dawna',
      ...
      },
      {
        ...
        consequence: 'Wysoka poprzeczka – trudna lekcja angielskiego',
        effect: { parentEnergy: -20, childFocus: -25, familyBond: -15, creativityMovement: 0 },
      ...
      },
      {
        ...
        consequence: 'Fascynująca nowość – „Adam gra w szachy”',
    ...
    choices: [
      {
        ...
        consequence: 'Przełączenie na angażującą historię',
        effect: { parentEnergy: -5, childFocus: 25, familyBond: 15, creativityMovement: 15 },
        nextNodeId: 'p4_ksiazka_adam',
      },
      {
        ...
        consequence: 'Kapitulacja pod wpływem nudy',
  ...
  p4_ksiazka_adam: {
    id: 'p4_ksiazka_adam',
    type: 'story',
    actTitle: 'Opowiadanie „Adam gra w szachy”',
    timeLabel: '17:50',
    progressPercent: 85,
    image: '/images/chess_book.jpg',
...
Dziecko przerywa, dotyka ilustracji i mówi: **„O, patrz, konik! A jak on się nazywa po angielsku?”**. Co robisz?`,
    choices: [
      {
        ...
        consequence: 'Idziemy za ciosem – wyciągamy planszę',
      ...
      },
      {
        ...
        consequence: 'Spokojne czytanie – najpierw cała historia',
      ...
      },
      {
        ...
        consequence: 'Pójście w język – szachowe wyzwanie słowne',
  ...
  p5_szachy_gra: {
    ...
    image: '/images/chess_book.jpg',
    title: 'Sukces! Wyzwanie cyfrowe opanowane w wielkim stylu!',
...
Wspólnie sprawdzacie zasady, rozgrywacie pełną śmiechu mini-partię, a w domu panuje wspaniała atmosfera.`,
    choices: [
      {
        id: 'CTA_CHESS',
...
Ma potężną satysfakcję, że bezbłędnie potrafi je wymówić. Nauka przez zabawę w najczystszej postaci.`,
    choices: [
      {
        id: 'CTA_ENGLISH',
        text: 'Przejdź do podsumowania i sprawdź zapowiedź książki',
  ...
  p3_tablet_zombi_tv: {
    ...
    type: 'game_over',
    actTitle: 'Ślepy Zaułek — Tablet Zombi TV',
    timeLabel: '18:30',
    progressPercent: 60,
  ...
  p3_tablet_zombi_wojna: {
    ...
    type: 'game_over',
    actTitle: 'Ślepy Zaułek — Zombi Wojna',
    timeLabel: '18:00',
    progressPercent: 60,
  ...
  p3_slodycze_skok_cukru: {
    ...
    type: 'game_over',
    actTitle: 'Ślepy Zaułek — Skok Cukru',
    timeLabel: '17:30',
    progressPercent: 60,
  ...
  p4_dwor_pelny_ekran: {
    ...
    type: 'game_over',
    actTitle: 'Ślepy Zaułek — Powrót do Ekranu',
    timeLabel: '18:30',
    progressPercent: 65,
  ...
  p4_dwor_awantura_izolacja: {
    ...
    type: 'game_over',
    actTitle: 'Ślepy Zaułek — Izolacja',
    timeLabel: '18:00',
    progressPercent: 65,
  ...
  p5_ksiazka_frustracja: {
    ...
    type: 'game_over',
    actTitle: 'Ślepy Zaułek — Frustracja Angielskim',
    timeLabel: '17:45',
    progressPercent: 75,
    text: `Próba nauki angielskiego na siłę, bez kontekstu zabawy, wywołała frustrację. Dziecko poczuło się oceniane jak w szkole, zamknęło książkę i ze złością odeszło od kanapy.`,
    finalStatsOverview: {
      childFocus: 15,
      familyBond: 35,
      parentEnergy: 30,
      creativityMovement: 20,
    },
    gameOverCommentary: `Zbyt wysoka poprzeczka bez elementów zabawy i fabuły rodzi opór. Wprowadzanie języka obcego działa najlepiej, gdy jest wplecione naturalnie w ciekawą historię.`,
    choices: [
      {
        id: 'RETRY',
        text: 'Cofnij czas i spróbuj jeszcze raz ➔ Przejdź do startu',
