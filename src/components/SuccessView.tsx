  ...
  return (
    <div className="w-full max-w-2xl mx-auto artistic-card border border-[#8a652e]/50 rounded-xl p-6 sm:p-8 shadow-xl relative">
      ...
      <div className="text-center mb-6 pt-2">
        ...
        <p className="font-sans text-sm text-[#5e564b] max-w-lg mx-auto">
      ...
      <div className="bg-[#faf8f5] border border-[#e2d9cc] rounded-lg p-5 mb-6 shadow-sm">
        <p className="font-serif text-base text-[#2c2825] leading-relaxed mb-4">
          {node.text}
        </p>

        <div className="border-t border-[#e2d9cc] pt-3.5 grid grid-cols-2 sm:grid-cols-4 gap-2.5 text-center font-mono text-xs">
          <div className="bg-[#ffffff] p-2.5 rounded border border-[#e2d9cc]">
            <span className="block text-[10px] text-[#736c61] uppercase tracking-wider">Energia</span>
            <span className="font-bold text-[#8a652e] text-sm">{finalStats.parentEnergy}%</span>
          </div>

          <div className="bg-[#ffffff] p-2.5 rounded border border-[#e2d9cc]">
            <span className="block text-[10px] text-[#736c61] uppercase tracking-wider">Skupienie</span>
            <span className="font-bold text-[#5e7a5b] text-sm">{finalStats.childFocus}%</span>
          </div>

          <div className="bg-[#ffffff] p-2.5 rounded border border-[#e2d9cc]">
            <span className="block text-[10px] text-[#736c61] uppercase tracking-wider">Relacja</span>
            <span className="font-bold text-[#8a652e] text-sm">{finalStats.familyBond}%</span>
          </div>

          <div className="bg-[#ffffff] p-2.5 rounded border border-[#e2d9cc]">
            <span className="block text-[10px] text-[#736c61] uppercase tracking-wider">Ruch</span>
            <span className="font-bold text-[#5e7a5b] text-sm">{finalStats.creativityMovement}%</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#faf8f5] border border-[#e2d9cc] rounded-xl p-5 sm:p-6 mb-6 shadow-sm">
        ...
        <p className="font-sans text-xs text-[#5e564b] leading-relaxed mb-4">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <button
          onClick={handleShare}
          className="flex-1 bg-[#ffffff] hover:bg-[#f3ede2] text-[#2c2825] border border-[#e2d9cc] font-mono text-xs py-3 px-4 rounded-lg flex items-center justify-center gap-2 transition-colors cursor-pointer"
        >
